 ...
 *   description: Product variant management and retrieval
 */
 ...
 *     description: Only admins can create product variants.
 ...
 *     description: Retrieve variant information by ID for a specific product.
 *     tags: [Product Variants]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Update variant information for a specific product.
 *     tags: [Product Variants]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Delete a variant by ID for a specific product.
 *     tags: [Product Variants]
 *     security:
 *       - bearerAuth: []
 *     parameters:
