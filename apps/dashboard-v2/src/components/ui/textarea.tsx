  ...
  return (
    <span
      ...
      className={cn([
        ...
        'dark:before:hidden',
        // Focus ring
        'after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:ring-inset after:ring-transparent sm:after:focus-within:ring-1 sm:after:focus-within:ring-blue-500',
        // Disabled state
