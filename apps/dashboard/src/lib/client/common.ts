...
function getOptions(options?: Omit<RequestInit, 'body'>, payload?: Record<string, any>): RequestInit {
...
>(path: string, payload?: TPayload, query?: TQuery, options?: Omit<RequestInit, 'body'>): Promise<TRes> {
