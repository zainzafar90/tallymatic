...
import { clx, Input, Label, Text } from '@medusajs/ui';
...
export const StringFilter = ({ filter, prefix, openOnMount }: StringFilterProps) => {
        ...
        >
          <div className="px-1 pb-3 pt-1">
            ...
            <div className="px-2 py-0.5">
              <Input name={key} size="small" defaultValue={query?.[0] || undefined} onChange={debouncedOnChange} />
            </div>
          </div>
        </Popover.Content>
      </Popover.Portal>
...
const StringDisplay = ({ label, value, onRemove }: { label: string; value?: string; onRemove: () => void }) => {
  return (
