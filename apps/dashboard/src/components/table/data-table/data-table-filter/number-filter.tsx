...
export const NumberFilter = ({ filter, prefix, openOnMount }: NumberFilterProps) => {
  ...
  return (
    <Popover.Root modal open={open} onOpenChange={handleOpenChange}>
      <NumberDisplay label={label} value={currentValue} onRemove={handleRemove} />
      <Popover.Portal>
        <Popover.Content
...
const NumberDisplay = ({ label, value, onRemove }: { label: string; value?: string[]; onRemove: () => void }) => {
